...
exports.saveBranch = async ({ name, code, address, desc, capacity, manager, owners, startTime, endTime }) => {
  return await BranchModel({ name, code, address, desc, capacity, manager, owners, startTime, endTime }).save()
}
